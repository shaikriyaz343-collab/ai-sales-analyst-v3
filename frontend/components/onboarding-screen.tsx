      ...
      <div className="onboarding-shell">
        ...
        <section className="onboarding-hero">
          <div className="hero-copy">
            ...
            <p>Upload a CSV or Excel file. We’ll understand the business model, validate the available signals, and prepare an analyst workspace grounded in your data.</p>
          </div>
